...
export default function PrimaryCard(props: WalletCard) {
  ...
  return (
    <div className="bg-[linear-gradient(104.3deg,#4A4A49_2.66%,#20201F_90.57%)] rounded-2xl px-7.5 py-4.5 relative w-88.5">
      <div className="flex items-center justify-start gap-2 mb-7">
        ...
        <p className="text-[#626260] text-xs font-medium">{lastName}</p>
      </div>
      ...
      <p className="text-white text-lg font-bold">{props.cardNumber}</p>
      <div className="flex items-start justify-between w-full">
        <p className="font-semibold text-sm text-[#868685]">
